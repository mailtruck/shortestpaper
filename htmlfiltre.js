...
/**
 * This function is borrowed from the ExpressJS engine
    ...
    if (res.statusCode < 200 || res.statusCode >= 400) {
      callback(new Error('request failed with status ' + res.statusCode + ' "' + http.STATUS_CODES[res.statusCode] + '"'));
        ...
        res.addListener('end', function () {
            callback(res.statusCode, buf, req, res);
        });
...
/**
 * Proxy functions that filters HTML queries
 *
 * @param {http.ServerRequest} Request
 * @param {Object}
 * @param {Function} htmlCallback is called when the query is an HTML query
 * @param {Function} nonHtmlCallback
 */
    ...
    switch (mimeType) {
      ...
      case "application/xhtml+xml":
            ...
            req.addListener("end", function () {
               ...
               // changing the header a little bit
               // turning off gzipping
               // turning off caching
